...
return [
    ...
    */
    ...
    'api_scopes' => env('SHOPIFY_API_SCOPES', 'read_products,write_products,read_orders,write_orders,read_customers,write_customers,write_purchase_options,read_themes,write_discounts,read_shipping,write_shipping'),
